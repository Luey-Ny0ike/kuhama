class AmmenitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ammenity.save
        format.html { redirect_to @ammenity, notice: 'Ammenity was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ammenity.update(ammenity_params)
        format.html { redirect_to @ammenity, notice: 'Ammenity was successfully updated.' }
  ...
  private
    ...
    def ammenity_params
      params.require(:ammenity).permit(:name, :icon)
    end
end
